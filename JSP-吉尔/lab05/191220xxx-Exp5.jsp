...
<head>
	...
	<title>实验5-xxx：EL与JSTL编程</title>
	<link rel="stylesheet" href="191220xxx-Exp5.css" type="text/css" />
</head>
...
<body>
	...
	<div id="content">
		...
		<div id="invform">
			...
			<p><font color="blue">JSTL（Java server pages standarded tag library，即JSP标准标签库）是由JCP（Java community Proces）所制定的标准规范，它主要提供给Java Web开发人员一个标准通用的标签库，并由Apache的Jakarta小组来维护。开发人员可以利用这些标签取代JSP页面上的Java代码，从而提高程序的可读性，降低程序的维护难度。
			</font></p>
			<b>切分后：</b><br>
			<br>
