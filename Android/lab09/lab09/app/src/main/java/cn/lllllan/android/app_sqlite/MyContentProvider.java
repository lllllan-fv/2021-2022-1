...
public class MyContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "cn.lllllan.android.app_sqlite.provider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case CONTACT_DIR:
                return "vnd.android.cursor.dir/vnd.cn.lllllan.android.app_sqlite.provider.contact";
            case CONTACT_ITEM:
                return "vnd.android.cursor.item/vnd.cn.lllllan.android.app_sqlite.provider.contact";
        }
        return null;
    }
